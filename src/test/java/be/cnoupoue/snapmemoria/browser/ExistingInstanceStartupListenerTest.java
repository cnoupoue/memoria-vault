...
class ExistingInstanceStartupListenerTest {
  ...
  @Test
  void opensExistingHealthySnapmemoriaInstanceAndExitsCleanly() {
    FakeInstanceProbe instanceProbe =
        new FakeInstanceProbe(InstanceProbeResult.HEALTHY_SNAPMEMORIA);
  ...
  @Test
  void doesNotTreatUnrelatedServiceAsSnapmemoria() {
  ...
  void doesNothingOutsideProductionProfile() {
    ...
    MockEnvironment environment =
        new MockEnvironment()
            .withProperty("snapmemoria.browser.auto-open", "true")
            .withProperty("snapmemoria.browser.url", APP_URL.toString());
  ...
  private static class FakeInstanceProbe extends LocalSnapmemoriaInstanceProbe {
