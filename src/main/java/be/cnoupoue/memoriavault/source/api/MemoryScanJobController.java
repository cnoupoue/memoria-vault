...
import be.cnoupoue.memoriavault.indexing.MemoryScanJob;
...
public class MemoryScanJobController {
  ...
  public MemoryScanJobController(MemoryScanJobService memoryScanJobService) {
  ...
  public MemoryScanJobResponse findLatestForSource(@PathVariable String sourceId) {
    return toResponse(memoryScanJobService.findLatestBySourceId(sourceId));
  }
